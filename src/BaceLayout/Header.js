  ...
  return (
    <header
      className={`${classes.header} ${
        ctx.isDarkMode ? classes.dark : classes.day
      }`}
    >
      <nav>
        <ul>
          ...
          <li>
            <NavLink activeClassName={classes.active} to="/hangman">
              Hangman
            </NavLink>
          </li>
          <li>
          ...
          <li>
            <NavLink activeClassName={classes.active} to="/shirt-draw">
              Shirt-Draw
            </NavLink>
          </li>
          <li>
            <NavLink activeClassName={classes.active} to="/type-game">
              Type-Game
            </NavLink>
          </li>
          <li>
            <NavLink activeClassName={classes.active} to="/person-todo">
              Person-todo
            </NavLink>
          </li>
          ...
          {/* <li><NavLink activeClassName={classes.active} style={{color:"yellow"}} to="/trelo">Trelo</NavLink></li> */}
